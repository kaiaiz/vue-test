...
//                    }
        ...
        created(){
            this.ruleForm2.mnum=this.$route.query.mnum;
            this.ruleForm2.mname=this.$route.query.mname;
            this.ruleForm2.mphone=this.$route.query.mphone;
        ...
        methods: {
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {    //获取dom对象
                    if (valid) {
                        fetch('/ajax/member/update',{
                            method:'post',
                            headers:{
                                "content-type":'application/x-www-form-urlencoded'
                            },
                            body:"mnum="+this.ruleForm2.mnum+"&mname="+this.ruleForm2.mname+"&mphone="+this.ruleForm2.mphone+"&mid="+this.id
                        }).then(function (e) {
                            return e.text();
                        }).then(function (e) {
                            if(e=="ok"){
